...
#define FORTRAN_FUNCTION    fortran int
#else
#define CALLED_FROM_FORTRAN void
#define FORTRAN_FUNCTION    extern int
#endif
 
/* These are the names to be used for the functions */
#ifdef CRAY
#define KERNEL kernel
#define KERN12 kern12
#define TRACE  trace
#define SPACE  space
#define TEST   test
#define TRACK  track
